...
import com.zj.example.arch.livedata.retrofit.api.ApiEmptyResponse
import com.zj.example.arch.livedata.retrofit.api.ApiErrorResponse
...
@MainThread constructor(private val appExecutors: AppExecutors) {
    ...
    private fun fetchFromNetwork(dbSource: LiveData<ResultType>? = null) {
    ...
    @WorkerThread
    protected open fun processResponse(response: ApiSuccessResponse<ResultType>): ResultType {
